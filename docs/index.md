...
hero:
  ...
  tagline: "Initialize your backend in seconds and start developing your client application."
  image:
    src: ./assets/hero.png
    alt: Modular Rest
  actions:
...
features:
  ...
  - title: Server functions
    details: Write your server functions and use them on your client app.
  ...
  - title: Client Library
    details: Use client library to communicate with your server app, similar to firebase.
...
:root {
  ...
  --vp-home-hero-image-background-image: linear-gradient(-45deg, rgba(189, 52, 254, 0.2) 50%, rgba(71, 202, 255, 0.2) 50%);
