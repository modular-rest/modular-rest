...
module.exports.combineRoutesByFilePath = async (rootDirectory, app) => 
{
    // find route pathes
...
// combineServicesByFilePath combination
module.exports.combineServicesByFilePath = async (rootDirectory, filename, otherOption={}) => 
{
    // find route pathes
    let rootObject_temp = {};
    ...
    for (let i = 0; i < modulesPath.length; i++) 
    {
        ...
        if(otherOption.combineWithRoot)
        {
            ...
            rootObject_temp = extendObj(rootObject_temp, moduleObject);
        }
        // default act
        else {
